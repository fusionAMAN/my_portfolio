  ...
  const highlights = [
    {
      ...
      description: "800+ LeetCode, Codeforces, codechef problems solved with algorithmic thinking",
...
Proficient in backend development with strong command over JavaScript and Java, building scalable applications using Node.js, Express.js, the MERN stack, and Spring Boot. Experienced in designing RESTful APIs, implementing authentication and authorization, and optimizing server-side performance.
Skilled in Data Engineering using Databricks and PySpark for large-scale data processing, along with Power BI for data visualization and reporting. Possess a solid foundation in Data Structures & Algorithms, Object-Oriented Programming, DBMS, Operating Systems, and Computer Networks. Experienced with MongoDB, MySQL, Redis, and Microsoft Azure cloud technologies for building and deploying scalable solutions.
                  </motion.p>
                ...
                >
                  {[
                    ...
                    {
                      name: "Codeforces",
                      link: "https://codeforces.com/profile/40guptaaman",
                      gradient: "from-white-500 to-orange-600",
                    },
                  ].map((item, index) => (
                    <motion.a
                      key={index}
