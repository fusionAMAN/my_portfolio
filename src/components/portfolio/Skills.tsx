...
import { Code, Database, Wrench, Brain, BookOpen, CodeIcon, CloudFog, Server } from "lucide-react";
// Technology Icons
import {
  SiPython,
  SiJavascript,
...
const skillCategories = [
...

  {
    ...
    icon: CloudFog,
    skills: [
      { name: "Azure", icon: SiCloudflareworkers, color: "#0078D4" },
      { name: "AWS", icon: SiAmazonwebservices, color: "#FF3700" },
    ],
    color: "secondary",
  },
    {
    title: "Data Engineer Technology",
    icon: CodeIcon,
    skills: [
      { name: "Databricks", icon: SiDatabricks, color: "#0078D4" },
      {name: "ETL/ELT Pipeline", icon: SiJfrogpipelines, color:"#FF3700"},
      { name: "PowerBi", icon: SiGraphql, color: "#FF3700" },
    ],
    color: "secondary",
  },
];
